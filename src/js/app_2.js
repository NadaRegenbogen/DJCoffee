...
const divCurrentArtwork = document.querySelector("#current-artwork");
const pCurrentArtist = document.querySelector("#current-artist");
const pCurrentTrack = document.querySelector("#current-track");
const btnPlayPause = document.querySelector("#play-pause");
const spanCurrentTime = document.querySelector("#ct");
const spanTotalTime = document.querySelector("#tt");
